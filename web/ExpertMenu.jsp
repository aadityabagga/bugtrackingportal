    ...
    <body>
        ...
        <div id="header">
            <div class="shell">
                ...
                <div id="navigation">
                    <ul>
                        <li><a href="ExpertHome.jsp"><span>Home</span></a></li>
                        <li><a href="ViewBugs?state=Assigned"><span>Pending Bugs</span></a></li>
                        <li><a href="ViewBugs?state=All"><span>All Bugs</span></a></li>
                        <li><a href="ExpertReport"><span>Report</span></a></li>
                    </ul>
                </div>
                <!-- End Navigation -->
        ...
        <nav>
            <ul>
                        ...
                        <li><a href="ViewBugs?state=Assigned">Assigned bugs</a></li>
                        

                <li><a href="ViewBugs?state=All">View All Bugs</a></li>
                
                <li><a href="ViewBugs?state=Solved">View solved bugs</a></li>
